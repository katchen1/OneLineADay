...
class AnalyticsScreen extends React.Component {
  ...
  getNamedEntities = () => {
    ...
    this.state.user.entries.forEach(function (entry) {
      Object.values(entry.extractions).forEach(function (entity) {
        let tag = entity["tag_name"],
          word = entity["extracted_text"];
  ...
  sentimentOnPress = () => {
    ...
    this.navigation.navigate("Chart Details", {
  ...
  sentimentDistributionOnPress = () => {
    ...
    let sentimentCounts = [
      ["Positive", dist[0].freq],
      ["Neutral", dist[1].freq],
      ["Negative", dist[2].freq],
    ];
    this.navigation.navigate("Chart Details", {
      title: "Sentiment",
      ...
      <View style={styles.chartContainer}>
        ...
        <LineChart
          data={{
            ...
            datasets: [
              { data: data },
              { data: [-1 * range, range], color: () => "transparent" },
            ],
          }}
      ...
      <View style={styles.chartContainer}>
        <View style={styles.chartHeader}>
          ...
          <Ionicons
            ...
            size={28}
            color="gray"
            onPress={this.sentimentDistributionOnPress}
          />
        </View>
        <PieChart
          data={data}
  ...
  render() {
    ...
    let range = Math.max(
      Math.abs(Math.min(...lineChartData)),
      Math.abs(Math.max(...lineChartData))
    );
      ...
      <View style={styles.container}>
        <ScrollView style={styles.scrollView}>
          ...
          >
            ...
            <this.PieChartRender
              data={pieChartData}
              onPress={this.companiesOnPress}
            />
            <this.BarChartRender
              labels={locationLabels}
              data={locationData}
              tag={"Places"}
              onPress={this.placesOnPress}
            />
            <this.BarChartRender
              labels={personLabels}
              data={personData}
              tag={"People"}
              onPress={this.peopleOnPress}
            />
            <this.BarChartRender
